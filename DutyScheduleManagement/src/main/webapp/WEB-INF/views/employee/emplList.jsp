...
<div class="container"><hr>
	<h1 style="text-align:center; font-family: 'Georgia', serif; font-style: italic"> Add an Employee </h1><br>
	<div class="container">
		<div class="col-md-4 col-md-offset-4">
			<form id="signup_frm" action="/empl/add" method="post">
	...
	<hr>
	<h1 style="text-align:center;  font-family: 'Georgia', serif; font-style: italic"> Added Employees </h1><br>
		...
		<div class="modal-dialog modal-sm">    
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Modify an employee information</h4>
				</div>
				<div class="modal-body">
					<form action="/empl/modify" method="post" id="m_frm" name="m_frm">
						<div class="form group">
							<label for="m_name"> Modified Name: </label>
							<input class="form-control" id="m_name" name="name" type="text" value="">
						</div>
						<div class="form group">
							<label for="m_email"> Modified Email: </label>
